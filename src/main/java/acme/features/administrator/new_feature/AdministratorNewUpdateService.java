...
@Service
public class AdministratorNewUpdateService implements AbstractUpdateService<Administrator, New> {
	...
	@Override
	public void update(final Request<New> request, final New entity) {
		assert request != null;
		assert entity != null;
